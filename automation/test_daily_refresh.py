...
class DailyRefreshTests(unittest.TestCase):
    ...
    def test_reconcile_prunes_empty_unresolved_rows(self):
        site = {
            "summary": {},
            "transfers": [],
            "creates": [],
            "exists": [],
            "unresolved": [
                {"fc_id": "27", "tm_id": "-", "player": "-", "source": "-", "target": "-"},
                {"fc_id": "-", "tm_id": "99", "player": "Test Oyuncu", "source": "-", "target": "Yeni Takım"},
            ],
        }
        result = daily.reconcile(site, {"players": {}}, {"teams": {}}, {"teams": {}})
        self.assertEqual(1, result["pruned_unresolved"])
        self.assertEqual(1, site["summary"]["unresolved"])
        self.assertEqual("99", site["unresolved"][0]["tm_id"])
